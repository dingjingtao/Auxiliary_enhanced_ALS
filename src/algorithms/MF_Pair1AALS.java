...
/**
 * Pairwise Auxiliary-enhanced eALS for weighted matrix factorization
 * 
 * @author jingtaoding
 */
public class MF_Pair1AALS extends TopKRecommender {
	/** Model priors to set. */
	...
	public MF_Pair1AALS(SparseMatrix trainMatrix, ArrayList<Rating> testRatings, SparseMatrix trainSideMatrix,
			...
			boolean showLoss, boolean validation) {
